...
export default function Home() {
  return (
    <main className="w-full  px-4  sm:pt-20 flex flex-col justify-center items-center">
      <div className="w-full h-[50vh] min-h-[700px] mb-12 relative flex flex-col justify-center items-center">
        <Art3D />
      ...
      <section className="flex flex-col justify-center items-center text-center mb-12">
